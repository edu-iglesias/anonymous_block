<?php 
	...
	$querrry = mysql_query("SELECT * FROM product_orders where status = 0");
				$num_rows = mysql_num_rows($querrry);
	$querrrry = mysql_query("SELECT * FROM accounts where status = 0");
				$num_rowss = mysql_num_rows($querrrry);			
            ...
            <div class="panel panel-warning">
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading"><?php echo $num_rowss;?></p>
                    <p class="announcement-text">Accounts for Approval</p>
                  </div>
                </div>
              </div>
              <a href="accounts.php">
