      ...
      <div id="page-wrapper"> 
			...
			<br>
			 <?php
				...
				$newid = $_GET['id'];
				$sql = "SELECT * FROM accounts WHERE user_id = $newid";
			...
			?>
			 <form class="form-horizontal" role="form" action="" method="post" > 
				<div class="form-group"> 
                    ...
                    <div class="col-sm-10"> 
                        <input type="name" name="fname" class="form-control" id="description"  value="<?php echo $row['fname']; ?>"> 
					</div> 
                </div>
				<div class="form-group"> 
                    <label for="description" class="col-sm-2 control-label">Last Name</label> 
                    <div class="col-sm-10"> 
                        <input type="name" name="lname" class="form-control" id="description"  value="<?php echo $row['lname']; ?>"> 
					</div> 
                </div>
