    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <li class="active"><a href="products-cms.php"><i class="fa fa-edit"></i> Products</a></li>
            </li>
          </ul>
      ...
      <div id="page-wrapper">
		...
		<div class="panel panel-default"> 
		 ...
		 <center>
			...
			<?php 
				$querry = mysql_query("SELECT * FROM products");
				while($rows = mysql_fetch_assoc($querry))
				{
						$id = $rows['id'];
						$name = $rows['name'];
			...
			<br><br><br>
                <div class="thumbnail">
					...
					<div class="caption">
                     ...
                     <a href="edit-products.php?id=<?php echo $id ?>" class="btn btn-default">Update</a>
                        
						 <a href="deleteproducts.php?id=<?php echo $id ?>" class="btn btn-default">Delete</a>
