...
if(isset($_POST["add"]))
{
	...
	else
	{
		...
		$queryy = "INSERT INTO cart set customer_num='$customer',product=$prod,quantity=$quantity,tprice=$price,size='$size_iday',thru='$thru'";
				...
				<form action="" method="post">
					...
					<div class="form-group">
						<div class="col-lg-10">
							<div class="radio">
								<label>
									<input type="radio" name="optionsRadios" id="optionsRadios1" value="pickup" checked="">
									Pick-up
								</label>
							</div>
							<div class="radio">
								<label>
									<input type="radio" name="optionsRadios" id="optionsRadios1" value="delivery">
									Delivery
								</label>
							</div>
						</div>
